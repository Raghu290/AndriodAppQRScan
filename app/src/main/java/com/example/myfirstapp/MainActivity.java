...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String appId = "AE561565-D55B-6CBA-FF58-60102DAB6B00";
    private static final String apiKey = "316A6FA8-A094-3A6A-FF0B-9483F3E05200";
    ...
    private void backendlessLogin(View view) {
        ...
        Backendless.UserService.login(MainActivity.this.userName, MainActivity.this.userPassword, new AsyncCallback<BackendlessUser>() {
            ...
            public void handleResponse(BackendlessUser response) {
                ...
                System.out.print("userToken : "+userToken);
    ...
    private void backendlessLogout(View view) {
        Backendless.UserService.logout(new AsyncCallback<Void>() {
            ...
            public void handleResponse(Void response) {
                ...
                button_login_logout.setText("LOGIN TEMASEK APP");
    ...
    private void loginWithQRCode(String channelName) {
        ...
        if (userToken == null) {
            System.out.print("userToken : null");
